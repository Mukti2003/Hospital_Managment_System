        ...
        <div class="app-main">
                ...
                <div class="app-main__outer">
                    <div class="app-main__inner">   
                        <!-- All Patient Details -->
                        <div class="card shadow border-0 mb-7 con">
                            <div id="container">
                                ...
                                <form action="Admin_appointment.php" method="post">
                                    <fieldset>
                                        ...
                                        <input type="tel" id="tel" placeholder="Include country code" name="mobile">
                                    </fieldset>
                                    ...
                                    <fieldset>
                                        ...
                                        echo '<select id="appointment_for" name="service" required>';
                                        ...
                                        <textarea id="appointment_description" name="address" placeholder="I wish to get an appointment to skype for resolving a software problem."></textarea>
                                        <label for="date">Date*:</label>
                                        <input type="date" name="date" value="" required/>
                                        <br>
                                        <label for="time">Time*:</label>
                                        <input type="time" name="time" step="2" id="time" class="form-control" required/>
                                        <br>
