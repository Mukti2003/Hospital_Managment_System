        ...
        <div class="app-main">
                ...
                <div class="app-main__outer">
                    <div class="app-main__inner">   
                        <!-- All Patient Details -->
                        <div class="container">
                            <h2 class="text-center"><u>Doctor Registration</u></h2>
                            <form action="doctor_regi.php" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="exampleInputphoneno" name="phone" required/>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="d-flex">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="password" class="form-control" id="exampleInputPassword" name="cpassword" required/>
                                    </div>
                                </div>
                                <div class="d-flex">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            if ($result) {
                                            echo '<label class="control-label" for="appointmentfor">City:</label>';
                                            echo '<select id="appointmentfor" name="city" class="form-control">';
